 ...
 * @param cb
 */
 //[db-inspect]  makes db call to find events
 ...
 * @param cb
 */
 //[db-inspect]  makes db call to delete event
...
//[db-inspect]  makes db call to delete events 
 ...
 */
 ...
 //[db-inspect] makes db call to update event
