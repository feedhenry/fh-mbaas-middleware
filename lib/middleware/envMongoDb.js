 ...
 *  */
//[db-inspect] makes db call to remove a db for env
 ...
 * @param next
 */
//[db-inspect]  makes db calls to get or create a db for an env
...
//[db-inspect] makes db calls to get db for a env
...
//[db-inspect] makes db calls to get env db
